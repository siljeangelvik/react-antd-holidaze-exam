    ...
    return (
        <div className="alert-success" handletoggle={displayModal} style={{display: toggle && displayModal}}>
            <div style={{minWidth: '300px', maxWidth: '480px', margin: '0 auto', padding: "20px"}}>
                ...
                <p>You successfully booked the venue <strong>{specificVenue?.name}</strong> for <strong>{formatCurrency(specificVenue?.price)}</strong>  /night.
                    <br/>
                ...
                <div style={{display: "flex", flexWrap: "nowrap", gap: "10px", width: "100%"}}>
                    ...
                    <Link to="/bookings" className="primary-button" style={{width: "200px", height: "37px"}}>View Your Bookings</Link>
                </div>
            </div>
        </div>
    );
