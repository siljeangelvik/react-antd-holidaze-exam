        ...
        return (
            <div className='create-venue-modal'>
                <Content className="form-content" style={{paddingTop: "10px", paddingBottom: "10px", display: "flex", flexDirection: "column"}}>
                    <form onSubmit={formik.handleSubmit} style={{minWidth: '340px', maxWidth: '340px', margin: '0 auto', paddingTop: '40px'}}>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(event) => formik.setFieldValue("media", event.target.files)}
                            />
                            {formik.values.media.length === 0 ? (
                                <span>No files added</span>
                            ) : (
                                <output name="addedMedia" htmlFor="venueMedia">
                                    {Array.from(formik.values.media).map((file, index) => (
                        ...
                        <button className="primary-button" type="submit" style={{marginTop: "20px"}}>Create New Venue</button>
                    </form>
                </Content>
            </div>
        );
